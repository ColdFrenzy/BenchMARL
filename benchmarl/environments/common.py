...
from environments.ma_cont_uav_env import MultiAgentContinuousUAV
...
class MultiAgentContinuousUAVTasks(Task):
    ...
    REACH_TARGET = None  # Loaded automatically from conf/task/customenv/task_1
    ENCIRCLE_TARGET = None  # Loaded automatically from conf/task/customenv/task_2
...
class MultiAgentContinuousUAVBMWrapper(TaskClass):
    ...
    def get_env_fun(
        ...
        return lambda: PettingZooWrapper(
            MultiAgentContinuousUAVPettingZooWrapper(),
