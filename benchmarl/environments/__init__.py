...
from .customenv.common import MultiAgentUAVBMWrapper, MultiAgentUAVTasks
...
tasks = [VmasTask, Smacv2Task, PettingZooTask, MeltingPotTask, MAgentTask, MultiAgentUAVTasks]
