...
from .customenv.common import MultiAgentContinuousUAVBMWrapper, MultiAgentContinuousUAVTasks
...
tasks = [VmasTask, Smacv2Task, PettingZooTask, MeltingPotTask, MAgentTask, MultiAgentContinuousUAVTasks]
